...
<!-- 注册流程图 -->
![注册流程](./screenshots/register-flow.png)
...
<!-- 登录时序图 -->
![登录时序](./screenshots/login-sequence.png)
...
<!-- Token Rotation 流程 -->
![Token Rotation](./screenshots/token-rotation.png)
...
<!-- 前端登录流程 -->
![前端登录流程](./screenshots/frontend-login.png)
